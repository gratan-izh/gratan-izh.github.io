...
(function(){
  ...
  /* enforce-router */
    ...
    if(page || search){
      ...
      e.preventDefault();
      const base = 'pdfviewer/viewer.html?file=../gratan_price.pdf#view=FitH';
const url  = page ? (base + '&page=' + page)
                  : (base + '&search=' + encodeURIComponent(search) + '&highlightAll=true');
setPdf(url);
    }
  }, {passive:false});
